    ...
    <Contaier>
      ...
      <ProfileWrap>
          ...
          <ProfileInfo>
            <ProfileNickName>
              ...
              <svg
                ...
                fill="none"
              >
                <g clipPath="url(#clip0_168_5473)">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M7.85349 5.64659C7.94722 5.74035 7.99988 5.86751 7.99988 6.00009C7.99988 6.13267 7.94722 6.25983 7.85349 6.35359L5.02499 9.18209C4.97887 9.22985 4.92369 9.26794 4.86269 9.29414C4.80169 9.32035 4.73608 9.33414 4.66969 9.33472C4.6033 9.33529 4.53746 9.32264 4.47601 9.2975C4.41456 9.27236 4.35874 9.23523 4.31179 9.18829C4.26484 9.14134 4.22772 9.08552 4.20258 9.02407C4.17744 8.96262 4.16479 8.89678 4.16536 8.83039C4.16594 8.764 4.17973 8.69839 4.20594 8.63739C4.23214 8.57639 4.27023 8.52121 4.31799 8.47509L6.79299 6.00009L4.31799 3.52509C4.22691 3.43079 4.17651 3.30449 4.17765 3.17339C4.17879 3.04229 4.23137 2.91688 4.32408 2.82418C4.41678 2.73148 4.54219 2.67889 4.67329 2.67775C4.80439 2.67661 4.93069 2.72701 5.02499 2.81809L7.85349 5.64659Z"
                    fill="black"
                  />
                </g>
                <defs>
                  <clipPath id="clip0_168_5473">
        ...
        <ProfileFeel>
          ...
          <ProfileFeelAvg>
            <EnotionP>
              평균적으로 불안하고 지친 감정이 많아요. 에너지 소비를 많아
              지치시는 편이에요.
            </EnotionP>
          </ProfileFeelAvg>
        </ProfileFeel>
